...
function bp_course_all_mails(){
    $bp_course_mails = array(
        ...
        'student_course_certificate'=>array(
            ...
            'message' =>  sprintf(__('You\'ve obtained a certificate in Course : %s. Certificate link : %s','vibe'),'{{{course.titlelink}}}','{{{certificate.link}}}')
        ),
        ...
        'instructor_unit_comment'=>array(
            ...
            'message' =>  sprintf(__('Student %s added a comment "%s" in unit %s in course','vibe'),'{{{student.userlink}}}','{{comment.comment_content}}','{{{unit.link}}}')
        ),
        ...
        'student_quiz_evaluation'=>array(
            ...
            'message' =>  sprintf(__('You obtained %s out of %s in quiz %s , remarks by instructor %s ','vibe'),'{{quiz.marks}}','{{quiz.max}}','{{{quiz.titlelink}}}','{{quiz.remarks}}') 
        ),
