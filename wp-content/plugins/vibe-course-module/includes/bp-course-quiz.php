        ...
        function wplms_quiz($quiz_id,$ajax=false,$in_course){
            ...
            $wplms_quiz_data = apply_filters('wplms_wplms_quiz_tab_settings',array(
                ...
                'translations'=>array(
                    ...
                    'unattempted' =>_x('Unattempted','','vibe'),
                    'correct' => _x('Correct','','vibe'),
                    'correct_percentage' => _x('Correct Percentage','','vibe'),
                    'incorrect'=>_x('Incorrect','','vibe'),
                    'historical' => _x('Overall correct percentages by each question','','vibe'),
                    'q' => _x('Q','Advance stats for question in quiz result','vibe'),
                ),
            ));
            $color = '#54bbff';
