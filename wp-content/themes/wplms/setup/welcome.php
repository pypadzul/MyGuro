	...
	function get_demo_plugins(){
		return apply_filters('get_demo_plugins_array',array(
				...
				'demo16'=>array(
					'label'=>'Demo 16',
					'slug'=>'wplms_demo16',
					'file'=>'wplms_demo16/wplms_demo16.php',
					'download_link'=>'http://wplms.io/demos/demodata/plugins/wplms_demo16.zip',
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo16/')?(vibe_check_plugin_installed('wplms_demo16/wplms_demo16.php')?1:0):0)
				),
				'demo17'=>array(
					'label'=>'Demo 17',
					'slug'=>'wplms_demo17',
					'file'=>'wplms_demo17/wplms_demo17.php',
					'download_link'=>'http://wplms.io/demos/demodata/plugins/wplms_demo17.zip',
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo17/')?(vibe_check_plugin_installed('wplms_demo17/wplms_demo17.php')?1:0):0)
				)
			));
	}
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-9-8/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>Quizzes on React(Faster & Better)</h4>
						<p>Now use react quizzes for better faster processing less server load and optimized data saving!.</p>
						<a href="https://wplms.io/support/knowledge-base/quizzes-on-react/" class="button"><?php _e( 'Link', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>Advanced quiz stats in React quizzes</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/advancedquizstats.png' ?>" alt="reactquiz">
						</p>
						<a href="https://wplms.io/support/knowledge-base/advanced-quiz-statistics-in-react-quizzes/" class="button" target="_blank">Link</a>

					</div>
					<div>
						<h4>Demo 16</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo16.jpg' ?>" alt="reactquiz">
						</p>
						<a href="https://wplms.io/demos/demo16" class="button" target="_blank">Link</a>

					</div>
					<div>
						<h4>Demo 17</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo17.jpg' ?>" alt="reactquiz">
						</p>
						<a href="https://wplms.io/demos/demo17" class="button" target="_blank">Link</a>
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>Dark theme</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/darktheme.png' ?>" alt="reactquiz">
						</p>

					</div>
					<div>
						<h4>Mooc header refined</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/newmoocheader.png' ?>" alt="reactquiz">
						</p>
			...
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						...
						<p>Set users as Parents or Guardians, to allow study tracking of their children.</p>
						<a href="https://wplms.io/downloads/wplms-parent-user/" class="button" target="_blank">Download link</a>
